...
\subsection{Training}
\label{sec:DesignTraining} %TODO edit code in realisation
\subsubsection{Input}
...
\subsection{Verify}
\label{sec:DesignTest} %TODO edit code in realisation
\subsubsection{Input}
...
\\
Für eine genaue Anleitung für das Einlesen und Interpretieren in Python ist die Webseite \href{https://androidkt.com/extract-images-from-mnist-idx3-ubyte-file-format-in-python/}{AndroidKT} zu kontaktieren.\footnote{} %TODO add zitat
