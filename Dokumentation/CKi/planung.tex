...
\begin{landscape} 
	\begin{figure}[tb] 
		\centering 
		\includegraphics[width=\paperwidth,height=\paperheight]{gantt1.jpg} 
		\label{fig:planunggantt1} 
	\end{figure} 

	\begin{figure}[tb] 
		\centering 
		\includegraphics[width=\paperwidth,height=\paperheight]{gantt2.jpg} 
		\label{fig:planunggantt2} 
	\end{figure} 

	\begin{figure}[tb] 
		\centering 
		\includegraphics[width=\paperwidth,height=\paperheight]{gantt3.jpg} 
		\label{fig:planunggantt3} 
	\end{figure}
	 
	\begin{figure}[tb] 
		\centering 
		\includegraphics[width=\paperwidth,height=\paperheight]{gantt4.jpg} 
